...
export const ERROR_CODES = API_ERRORS
...
export function errorResponse(res, statusCode, code, message, details = {}) {
  return res.status(statusCode).json(createError(code, message, details))
}
